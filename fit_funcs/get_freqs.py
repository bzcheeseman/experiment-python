...
class get_freqs_live(live_fitter):
	...
	def get_freqs_live(self, title, xdata, ydata, parms, domain, upper = None, liveplot = True):
		parms, chi, yFit, yuFit, xpeaks = self.name.multi_lorentzian(xdata, ydata, parms, self.nres, domain, upper, outside_use = True)
